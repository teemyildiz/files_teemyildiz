...
if not database:get(bot_id..'teemyildiz:Reply:Mute'..msg.chat_id_) then
if text == 'هلو' then
...
database:del(bot_id..'teemyildiz:Reply:Mute'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'☑┇تم تفعيل ردود البوت')
return false
end

if text == 'تعطيل ردود البوت' and Owner(msg) then
database:set(bot_id..'teemyildiz:Reply:Mute'..msg.chat_id_,true)
